...
export const JSON_API_PRODUCTS = "http://localhost:8001/api/v1/Products";
export const JSON_API_ORDER = "http://localhost:7000/orderHistory";
export const JOSN_API_BROWSER = "http://localhost:7000/browsinHistory";
...
export const AUTH_API_REG = "http://localhost:8001/api/v1/registration";
export const AUTH_API_LOGI = "http://localhost:8001/api/v1/login";
