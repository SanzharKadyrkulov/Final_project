...
const ProductDetails = () => {
  ...
  const getRating = () => {
    let sum = productDetails?.ratings.reduce((a, b) => {
      return a + b.rating;
    }, 0);
    return sum / productDetails?.ratings.length;
  };
    ...
    <>
      <MainLayout>
        {productDetails ? (
          ...
          <>
            <div
              style={{ display: "flex", maxWidth: "1240px", margin: "0 auto" }}
            >
              <img
              ...
              <div style={{ width: "100%" }}>
                <h2>
                  {productDetails.type} {productDetails.title}
                </h2>
                <div
                  style={{
                    display: "flex",
                ...
                >
                  ...
                  <div>
                    <CommentIcon
                      ...
                      color="warning"
                      // onClick={() =>
                      //   history.push(`/rating/${productDetails.id}`)
                      // }
                    />
                  </div>
                  {/* </IconButton> */}
                ...
                <Button
                  style={
                    checkItemInCart(productDetails.id) ? contained : outlined
                  }
                  color="secondary"
                ...
                >
                  {checkItemInCart(productDetails.id)
                    ? "Remove from cart"
                    : "Add to cart"}
                </Button>
                <ProductRating />
